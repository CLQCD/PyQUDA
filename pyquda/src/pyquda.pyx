...
cdef class QudaGaugeObservableParam:
    ...
    def set_qcharge_density(self, Pointer value):
        assert value.dtype == "void"
...
def setVerbosityQuda(enum_quda.QudaVerbosity verbosity, const char prefix[], Pointer outfile):
