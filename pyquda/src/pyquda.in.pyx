...
def computeGaugeFixingOVR2Quda(Pointers rotation, Pointers gauge, double tol, int maxiter, int dir_ignore, double omega, QudaGaugeParam param):
    return quda.computeGaugeFixingOVR2Quda(rotation.ptr, gauge.ptr, tol, maxiter, dir_ignore, omega, &param.param)
