...
def computeGaugeFixingOVR2Quda(Pointers rotation, Pointers gauge, double tol, int maxiter, int dir_ignore, double relax_boost, int verbose_interval, int use_theta, QudaGaugeParam param):
    return quda.computeGaugeFixingOVR2Quda(rotation.ptr, gauge.ptr, tol, maxiter, dir_ignore, relax_boost, verbose_interval, use_theta, &param.param)
