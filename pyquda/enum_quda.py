...
class QudaInverterType(IntEnum):
    ...
    QUDA_SD_INVERTER = 5
    QUDA_PCG_INVERTER = 6
    QUDA_MPCG_INVERTER = 7
    QUDA_EIGCG_INVERTER = 8
    QUDA_INC_EIGCG_INVERTER = 9
    QUDA_GMRESDR_INVERTER = 10
    QUDA_GMRESDR_PROJ_INVERTER = 11
    QUDA_GMRESDR_SH_INVERTER = 12
    QUDA_FGMRESDR_INVERTER = 13
    QUDA_MG_INVERTER = 14
    QUDA_BICGSTABL_INVERTER = 15
    QUDA_CGNE_INVERTER = 16
    QUDA_CGNR_INVERTER = 17
    QUDA_CG3_INVERTER = 18
    QUDA_CG3NE_INVERTER = 19
    QUDA_CG3NR_INVERTER = 20
    QUDA_CA_CG_INVERTER = 21
    QUDA_CA_CGNE_INVERTER = 22
    QUDA_CA_CGNR_INVERTER = 23
    QUDA_CA_GCR_INVERTER = 24
