...
QUDA_INVALID_ENUM = QudaConstant.QUDA_INVALID_ENUM
...
class QudaInverterType(IntEnum):
    ...
    QUDA_GCR_INVERTER = 2
    QUDA_MR_INVERTER = 3
    QUDA_MPBICGSTAB_INVERTER = 4
    QUDA_SD_INVERTER = 5
    QUDA_XSD_INVERTER = 6
    QUDA_PCG_INVERTER = 7
    QUDA_MPCG_INVERTER = 8
    QUDA_EIGCG_INVERTER = 9
    QUDA_INC_EIGCG_INVERTER = 10
    QUDA_GMRESDR_INVERTER = 11
    QUDA_GMRESDR_PROJ_INVERTER = 12
    QUDA_GMRESDR_SH_INVERTER = 13
    QUDA_FGMRESDR_INVERTER = 14
    QUDA_MG_INVERTER = 15
    QUDA_BICGSTABL_INVERTER = 16
    QUDA_CGNE_INVERTER = 17
    QUDA_CGNR_INVERTER = 18
    QUDA_CG3_INVERTER = 19
    QUDA_CG3NE_INVERTER = 20
    QUDA_CG3NR_INVERTER = 21
    QUDA_CA_CG_INVERTER = 22
    QUDA_CA_CGNE_INVERTER = 23
    QUDA_CA_CGNR_INVERTER = 24
    QUDA_CA_GCR_INVERTER = 25
...
class QudaCloverFieldOrder(IntEnum):
    ...
    QUDA_PACKED_CLOVER_ORDER = 5  # even-odd, QDP packed
    QUDA_QDPJIT_CLOVER_ORDER = 6  # (diagonal / off-diagonal)-chirality-spacetime
    QUDA_BQCD_CLOVER_ORDER = 7  # even-odd, super-diagonal packed and reordered
