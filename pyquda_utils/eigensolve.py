...
def laplace3d(
    ...
    with gauge.use() as dirac:
        dirac.invert_param.dslash_type = QudaDslashType.QUDA_LAPLACE_DSLASH
        dirac.invert_param.mass = -1
        dirac.invert_param.kappa = 1 / 6
        dirac.invert_param.laplace3D = 3
